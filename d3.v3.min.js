!function() {
    ...
    function O() {
        var n = ".dragsuppress-" + ++wa,
            t = "click" + n,
            e = $o.select(Ko).on("touchmove" + n, d).on("dragstart" + n, d).on("selectstart" + n, d);
        if (ba) {
            var r = Go.style,
                u = r[ba];
            r[ba] = "none"
    ...
    function tt(n, t, e) {
        ...
        var i,
            o;
        return n = isNaN(n) ? 0 : (n %= 360) < 0 ? n + 360 : n, t = isNaN(t) ? 0 : 0 > t ? 0 : t > 1 ? 1 : t, e = 0 > e ? 0 : e > 1 ? 1 : e, o = .5 >= e ? e * (1 + t) : e + t - e * t, i = 2 * e - o, pt(u(n + 120), u(n), u(n - 120))
    }
    function et(n, t, e) {
        return new rt(n, t, e)
    }
    ...
    function ut(n, t, e) {
        return isNaN(n) && (n = 0), isNaN(t) && (t = 0), it(e, Math.cos(n *= La) * t, Math.sin(n) * t)
    }
    function it(n, t, e) {
        return new ot(n, t, e)
    }
    ...
    function at(n, t, e) {
        var r = (n + 16) / 116,
            u = r + t / 500,
            i = r - e / 200;
        return u = st(u) * Oa, r = st(r) * Ya, i = st(i) * Ia, pt(ft(3.2404542 * u - 1.5371385 * r - .4985314 * i), ft(-.969266 * u + 1.8760108 * r + .041556 * i), ft(.0556434 * u - .2040259 * r + 1.0572252 * i))
    }
    function ct(n, t, e) {
        return n > 0 ? et(Math.atan2(e, t) * za, Math.sqrt(t * t + e * e), n) : et(0 / 0, 0 / 0, n)
    }
    function st(n) {
    ...
    function yt(n, t, e) {
        var r,
            ...
            a = o - i,
            c = (o + i) / 2;
        return a ? (u = .5 > c ? a / (o + i) : a / (2 - o - i), r = n == o ? (t - e) / a + (e > t ? 6 : 0) : t == o ? (e - n) / a + 2 : (n - t) / a + 4, r *= 60) : (r = 0 / 0, u = c > 0 && 1 > c ? 0 : r), Q(r, u, c)
    }
    function xt(n, t, e) {
        n = Mt(n), t = Mt(t), e = Mt(e);
        var r = lt((.4124564 * n + .3575761 * t + .1804375 * e) / Oa),
            u = lt((.2126729 * n + .7151522 * t + .072175 * e) / Ya),
            i = lt((.0193339 * n + .119192 * t + .9503041 * e) / Ia);
        return it(116 * u - 16, 500 * (r - u), 200 * (u - i))
    }
    function Mt(n) {
    ...
    function kt(n, t, e, r) {
        ...
        return !Ko.XDomainRequest || "withCredentials" in c || !/^(http(s)?:)?\/\//.test(n) || (c = new XDomainRequest), "onload" in c ? c.onload = c.onerror = u : c.onreadystatechange = function() {
            ...
            return c.abort(), i
        }, $o.rebind(i, o, "on"), null == r ? i : i.get(Et(r))
    }
    function Et(n) {
    ...
    function At() {
        var n = Ct(),
            t = Nt() - n;
        t > 24 ? (isFinite(t) && (clearTimeout(Ja), Ja = setTimeout(At, t)), Wa = 0) : (Wa = 1, Ka(At))
    }
    function Ct() {
        var n = Date.now();
        for (Ga = $a; Ga;)
    ...
    function Nt() {
        for (var n, t = $a, e = 1 / 0; t;)
            t.f ? t = n ? n.n = t.n : $a = t.n : (t.t < e && (e = t.t), t = (n = t).n);
        return Ba = n, e
    }
    function Lt(n, t) {
    ...
    function qt(n) {
        ...
        return function(n) {
            ...
            "$" === c && (v = u[0], d = u[1]), "r" != g || h || (g = "g"), null != h && ("g" == g ? h = Math.max(1, Math.min(21, h)) : ("e" == g || "f" == g) && (h = Math.max(0, Math.min(20, h)))), g = tc.get(g) || Tt;
            var y = s && f;
            return function(n) {
                if (m && n % 1)
                    return "";
    ...
    function Dt(n, t, e) {
        ...
        function u(e) {
            return t(e = n(new rc(e - 1)), 1), e
        }
        function i(n, e) {
            return t(n = new rc(+n), e), n
        }
        function o(n, r, i) {
            var o = u(n),
                a = [];
    ...
    function Ut(n) {
        function t(n) {
            function t(t) {
                for (var e, u, i, o = [], a = -1, c = 0; ++a < r;)
                    37 === n.charCodeAt(a) && (o.push(n.substring(c, a)), null != (u = ic[e = n.charAt(++a)]) && (e = n.charAt(++a)), (i = C[e]) && (e = i(t, null == u ? "e" === e ? " " : "0" : u)), o.push(e), c = a + 1);
        ...
        function e(n, t, e, r) {
            for (var u, i, o, a = 0, c = t.length, s = e.length; c > a;) {
                ...
                if (u = t.charCodeAt(a++), 37 === u) {
                    if (o = t.charAt(a++), i = N[o in ic ? t.charAt(a++) : o], !i || (r = i(n, e, r)) < 0)
                        return -1
        ...
        var C = {
                ...
                j: function(n, t) {
                    return jt(1 + ec.dayOfYear(n), t, 3)
                },
                L: function(n, t) {
                ...
                U: function(n, t) {
                    return jt(ec.sundayOfYear(n), t, 2)
                },
                w: function(n) {
                    return n.getDay()
                },
                W: function(n, t) {
                    return jt(ec.mondayOfYear(n), t, 2)
                },
                x: t(h),
                X: t(g),
                y: function(n, t) {
    ...
    function Zt(n, t, e) {
        oc.lastIndex = 0;
        var r = oc.exec(t.substring(e, e + 4));
        return r ? (n.y = +r[0], e + r[0].length) : -1
    }
    function Vt(n, t, e) {
        oc.lastIndex = 0;
        var r = oc.exec(t.substring(e, e + 2));
    ...
    function Jt(n, t, e) {
        oc.lastIndex = 0;
        var r = oc.exec(t.substring(e, e + 3));
    ...
    function ee(n, t, e) {
        ac.lastIndex = 0;
        var r = ac.exec(t.substring(e, e + 1));
    ...
    function se() {
        ...
        pc.point = function(o, a) {
            pc.point = n, r = (t = o) * La, u = Math.cos(a = (e = a) * La / 2 + ka / 4), i = Math.sin(a)
        }, pc.lineEnd = function() {
            n(t, e)
        }
    }
    ...
    function Me() {
        function n(n, u) {
            ...
            dc += s, Mc += s * (t + (t = o)), _c += s * (e + (e = a)), bc += s * (r + (r = c)), xe(t, e, r)
        }
        var t,
            e,
            r;
        Ec.point = function(u, i) {
            u *= La;
            var o = Math.cos(i *= La);
            t = o * Math.cos(u), e = o * Math.sin(u), r = Math.sin(i), Ec.point = n, xe(t, e, r)
        }
    }
    function _e() {
        Ec.point = ye
    ...
    function be() {
        function n(n, t) {
            ...
            var e = Math.cos(t *= La),
                ...
                p = h && -X(g) / h,
                v = Math.atan2(h, g);
            wc += p * s, Sc += p * l, kc += p * f, dc += v, Mc += v * (r + (r = o)), _c += v * (u + (u = a)), bc += v * (i + (i = c)), xe(r, u, i)
        }
        var t,
            e,
            r,
        ...
        Ec.point = function(o, a) {
            t = o, e = a, Ec.point = n, o *= La;
            var c = Math.cos(a *= La);
            r = c * Math.cos(o), u = c * Math.sin(o), i = Math.sin(a), xe(r, u, i)
        }, Ec.lineEnd = function() {
            n(t, e), Ec.lineEnd = _e, Ec.point = ye
        }
    }
    function we() {
        return !0
            ...
            var g,
                ...
                y = {
                    ...
                    polygonEnd: function() {
                        ...
                        var n = ze(m, p);
                        g.length ? Se(g, Le, n, e, i) : n && (i.lineStart(), e(null, null, 1, i), i.lineEnd()), i.polygonEnd(), g = p = null
                    },
                    sphere: function() {
            ...
            if (l)
                for (var f = s[0], h = f[0], g = f[1] / 2 + ka / 4, p = Math.sin(g), v = Math.cos(g), d = 1;;) {
                    ...
                    var m = n[0],
                        ...
                        b = aa(_) > ka,
                        w = p * x;
                    if (gc.add(Math.atan2(w * Math.sin(_), v * M + w * Math.cos(_))), i += b ? _ + (_ >= 0 ? Ea : -Ea) : _, b ^ h >= e ^ m >= e) {
                        var S = he(le(f), le(n));
                        ve(S);
                        var k = he(u, S);
                        ve(k);
    ...
    function qe(n) {
        ...
        return {
            ...
            point: function(i, o) {
                var a = i > 0 ? ka : -ka,
                    c = aa(i - e);
                aa(c - ka) < Ca ? (n.point(e, r = (r + o) / 2 > 0 ? Aa : -Aa), n.point(u, r), n.lineEnd(), n.lineStart(), n.point(a, r), n.point(i, r), t = 0) : u !== a && c >= ka && (aa(e - u) < Ca && (e -= u * Ca), aa(i - a) < Ca && (i -= a * Ca), r = Te(e, r, i, o), n.point(u, r), n.lineEnd(), n.lineStart(), n.point(a, r), t = 0), n.point(e = i, r = o), u = a
            },
            lineEnd: function() {
                n.lineEnd(), e = r = 0 / 0
            },
    ...
    function Re(n, t, e, r) {
        var u;
        if (null == n)
            u = e * Aa, r.point(-ka, u), r.point(0, u), r.point(ka, u), r.point(ka, 0), r.point(ka, -u), r.point(0, -u), r.point(-ka, -u), r.point(-ka, 0), r.point(-ka, u);
        ...
        function e(n) {
            ...
            return {
                ...
                point: function(f, h) {
                    ...
                    if (!e && (s = c = v) && n.lineStart(), v !== c && (g = r(e, p), (me(e, g) || me(p, g)) && (p[0] += Ca, p[1] += Ca, v = t(p[0], p[1]))), v !== c)
            ...
            function c(n) {
                for (var t = 0, e = d.length, r = n[1], u = 0; e > u; ++u)
                    for (var i, o = 1, a = d[u], c = a.length, s = a[0]; c > o; ++o)
                        i = a[o], s[1] <= r ? i[1] > r && Z(s, i, n) && ++t : i[1] <= r && !Z(s, i, n) && --t, s = i;
                return 0 !== t
            }
            function s(i, a, c, s) {
                var l = 0,
    ...
    function Fe(n, t) {
        ...
        return e.invert = function(n, t) {
            var e = o - t;
            return [Math.atan2(n, e) / u, $((i - (n * n + e * e) * u * u) / (2 * u))]
        }, e
    }
    function Oe() {
        function n(n, t) {
    ...
    function Ye(n, t) {
        zc > n && (zc = n), n > Tc && (Tc = n), qc > t && (qc = t), t > Rc && (Rc = t)
    }
    function Ie() {
        function n(n, t) {
            o.push("M", n, ",", t, i)
    ...
    function Xe() {
        function n(n, r) {
            var u = n - t,
                i = r - e,
                o = Math.sqrt(u * u + i * i);
            Mc += o * (t + n) / 2, _c += o * (e + r) / 2, bc += o, Ve(t = n, e = r)
        }
        var t,
            e;
        Uc.point = function(r, u) {
            Uc.point = n, Ve(t = r, e = u)
        }
    }
    function $e() {
        Uc.point = Ve
    ...
    function Be() {
        function n(n, t) {
            var e = n - r,
                i = t - u,
                o = Math.sqrt(e * e + i * i);
            Mc += o * (r + n) / 2, _c += o * (u + t) / 2, bc += o, o = u * n - r * t, wc += o * (r + n), Sc += o * (u + t), kc += 3 * o, Ve(r = n, u = t)
        }
        var t,
            e,
            r,
        ...
        function u(t, e, r, a, c, s, l, f, h, g, p, v, d, m) {
            ...
            if (M > 4 * i && d--) {
                var _ = a + g,
                    ...
                    z = N - e,
                    q = x * L - y * z;
                (q * q / M > i || aa((y * L + x * z) / M - .5) > .3 || o > a * g + c * p + s * v) && (u(t, e, r, a, c, s, C, N, E, _ /= S, b /= S, w, d, m), m.point(C, N), u(C, N, E, _, b, w, l, f, h, g, p, v, d, m))
            }
        }
        var i = .5,
            o = Math.cos(30 * La),
    ...
    function tr(n) {
        ...
        function e(n) {
            return n = a.invert((n[0] - c) / h, (s - n[1]) / h), n && [n[0] * za, n[1] * za]
        }
        function r() {
            a = je(o = ir(m, y, x), i);
            var n = i(v, d);
        ...
        return t.stream = function(n) {
            ...
            return arguments.length ? (M = null == n ? (b = n, Ac) : De((b = +n) * La), u()) : b
            ...
            return arguments.length ? (v = n[0] % 360 * La, d = n[1] % 360 * La, r()) : [v * za, d * za]
        }, t.rotate = function(n) {
            return arguments.length ? (m = n[0] % 360 * La, y = n[1] % 360 * La, x = n.length > 2 ? n[2] % 360 * La : 0, r()) : [m * za, y * za, x * za]
    ...
    function cr(n, t) {
        function e(n, t) {
            var e = Math.cos(t),
                ...
                s = Math.sin(t),
                l = s * r + a * u;
            return [Math.atan2(c * i - l * o, a * r - s * u), $(l * i + c * o)]
        }
        var r = Math.cos(n),
            u = Math.sin(n),
            i = Math.cos(t),
        ...
        return e.invert = function(n, t) {
            var e = Math.cos(t),
                ...
                s = Math.sin(t),
                l = s * i - c * o;
            return [Math.atan2(c * i + s * o, a * r + l * u), $(l * r - a * u)]
        }, e
    }
    function sr(n, t) {
        var e = Math.cos(n),
        ...
        return function(u, i, o, a) {
            var c = o * t;
            null != u ? (u = lr(e, u), i = lr(e, i), (o > 0 ? i > u : u > i) && (u += o * Ea)) : (u = n + o * Ea, i = n - .5 * c);
    ...
    function vr(n, t, e, r) {
        var u = Math.cos(t),
            ...
            l = o * Math.cos(e),
            f = o * Math.sin(e),
            h = 2 * Math.asin(Math.sqrt(G(r - t) + u * o * G(e - n))),
            g = 1 / Math.sin(h),
            p = h ? function(n) {
                var t = Math.sin(n *= h) * g,
                    ...
                    u = e * s + t * f,
                    o = e * i + t * a;
                return [Math.atan2(u, r) * za, Math.atan2(o, Math.sqrt(r * r + u * u)) * za]
            } : function() {
                return [n * za, t * za]
            };
    ...
    function xr(n, t) {
        ...
        var r = Math.cos(n),
            ...
            i = r / u + n;
        return aa(u) < Ca ? rr : (e.invert = function(n, t) {
            var e = i - t;
    ...
    function qr(n) {
        Yr(n), Bc.remove(n), Gc.push(n), Gr(n)
    }
    function Tr(n) {
        var t = n.circle,
            e = t.x,
    ...
    function Rr(n) {
        ...
        if (Bc.insert(t, c), t || e) {
            if (t === e)
                return Yr(t), e = zr(t.site), Bc.insert(c, e), c.edge = e.edge = Xr(t.site, c.site), Or(t), Or(e), void 0;
            if (!e)
        ...
        for (var t, e, r, u, i, o, a, c, s, l, f = n[0][0], h = n[1][0], g = n[0][1], p = n[1][1], v = $c, d = v.length; d--;)
            if (i = v[d], i && i.prepare())
                for (a = i.edges, c = a.length, o = 0; c > o;)
                    l = a[o].end(), r = l.x, u = l.y, s = a[++o % c].start(), t = s.x, e = s.y, (aa(r - t) > Ca || aa(u - e) > Ca) && (a.splice(o, 0, new Wr($r(i.site, l, aa(r - f) < Ca && p - u > Ca ? {
                        x: f,
                        y: aa(t - f) < Ca ? e : p
                    } : aa(u - p) < Ca && h - r > Ca ? {
                        x: aa(e - p) < Ca ? t : h,
    ...
    function Yr(n) {
        var t = n.circle;
        t && (t.P || (Wc = t.N), Jc.remove(t), Kc.push(t), Gr(t), n.circle = null)
    }
    function Ir(n) {
        for (var t, e = Xc, r = Pe(n[0][0], n[0][1], n[1][0], n[1][1]), u = e.length; u--;)
            t = e[u], (!Zr(t, n) || !r(t) || aa(t.a.x - t.b.x) < Ca && aa(t.a.y - t.b.y) < Ca) && (t.a = t.b = null, e.splice(u, 1))
    }
    function Zr(n, t) {
        var e = n.b;
        if (e)
    ...
    function Xr(n, t, e, r) {
        var u = new Vr(n, t);
        return Xc.push(u), e && Br(u, n, t, e), r && Br(u, t, n, r), $c[n.i].edges.push(new Wr(u, n, t)), $c[t.i].edges.push(new Wr(u, t, n)), u
    }
    function $r(n, t, e) {
        var r = new Vr(n, null);
    ...
    function tu(n, t) {
        var e,
            ...
            u,
            i = n.sort(eu).pop();
        for (Xc = [], $c = new Array(n.length), Bc = new Jr, Jc = new Jr;;)
            if (u = Wc, i && (!u || i.y < u.y || i.y === u.y && i.x < u.x))
                (i.x !== e || i.y !== r) && ($c[i.i] = new Ur(i), Rr(i), e = i.x, r = i.y), i = n.pop();
            else {
                if (!u)
                    break;
                Tr(u.arc)
    ...
    function fu(n, t) {
        ...
        for (a < t.length && s.push(t.substring(a)), r = 0, i = l.length; (e = ns.exec(n)) && i > r; ++r)
            if (o = l[r], o.x == e[0]) {
                ...
                o.x = lu(parseFloat(e[0]), parseFloat(o.x));
        for (; i > r;)
    ...
    function zu(n) {
        var t = [n.a, n.b],
            ...
            u = qu(t, e),
            i = Tu(Ru(e, t, -u)) || 0;
        t[0] * e[1] < e[0] * t[1] && (t[0] *= -1, t[1] *= -1, r *= -1, u *= -1), this.rotate = (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * za, this.translate = [n.e, n.f], this.scale = [r, i], this.skew = i ? Math.atan2(u, i) * za : 0
    }
    function qu(n, t) {
        return n[0] * t[0] + n[1] * t[1]
    }
    ...
    function Xu(n, t) {
        return $o.rebind(n, t, "sort", "children", "value"), n.nodes = n, n.links = Ju, n
    }
    function $u(n) {
        return n.children
    }
    ...
    function ri(n) {
        return n.reduce(ui, 0)
    }
    function ui(n, t) {
        return n + t[1]
    }
    function ii(n, t) {
        return oi(n, Math.ceil(Math.log(t.length) / Math.LN2 + 1))
    }
    function oi(n, t) {
    ...
    function wi(n) {
        ...
        if ((e = n.children) && (s = e.length)) {
            var e,
                ...
                h = 1 / 0,
                g = -1 / 0;
            if (e.forEach(Si), r = e[0], r.x = -r.r, r.y = 0, t(r), s > 1 && (u = e[1], u.x = u.r, u.y = 0, t(u), s > 2))
                for (i = e[2], Ai(r, u, i), t(i), Mi(r, i), r._pack_prev = i, Mi(i, u), u = r._pack_next, o = 3; s > o; o++) {
                    Ai(r, u, i = e[o]);
                    var p = 0,
                        v = 1,
                        d = 1;
                    ...
                    if (1 == p)
                        for (c = r._pack_prev; c !== a._pack_prev && !bi(c, i); c = c._pack_prev, d++)
                            ;
                    p ? (d > v || v == d && u.r < r.r ? _i(r, u = a) : _i(r = c, u), o--) : (Mi(r, i), u = i, t(i))
                }
            var m = (l + f) / 2,
                y = (h + g) / 2,
                x = 0;
    ...
    function zi(n) {
        var t,
            e = n.children;
        return e && (t = e.length) ? zi(e[t - 1]) : n
    }
    function qi(n) {
        return {
            x: n.x,
    ...
    function Di(n) {
        return n.rangeExtent ? n.rangeExtent() : Ri(n.range())
    }
    function Pi(n, t, e, r) {
        var u = e(n[0], n[1]),
            i = r(t[0], t[1]);
    ...
    function Fi(n, t, e, r) {
        function u() {
            var u = Math.min(n.length, t.length) > 2 ? Hi : Pi,
                c = r ? Uu : Pu;
    ...
    function Vi(n, t, e) {
        var r = Ii(n, t);
        return $o.format(e ? e.replace(nc, function(n, t, e, u, i, o, a, c, s, l) {
            return [t, e, u, i, o, a, c, s || "." + $i(l, r), l].join("")
        }) : ",." + Xi(r[2]) + "f")
    }
    function Xi(n) {
    ...
    function $i(n, t) {
        var e = Xi(t[2]);
        return n in hs ? Math.abs(e - Xi(Math.max(Math.abs(t[0]), Math.abs(t[1])))) + +("e" !== n) : e - 2 * ("%" === n)
    }
    function Bi(n, t, e, r) {
        function u(n) {
        ...
        return o.invert = function(t) {
            ...
            if (!arguments.length)
                return gs;
            arguments.length < 2 ? t = gs : "function" != typeof t && (t = $o.format(t));
            var r,
    ...
    function Wi(n, t, e) {
        ...
        return r.invert = function(t) {
            ...
            return r.domain(Yi(e, n))
        }, r.exponent = function(o) {
            return arguments.length ? (u = Ji(t = o), i = Ji(1 / t), n.domain(e.map(u)), r) : t
        }, r.copy = function() {
    ...
    function oo(n) {
        ...
        return t.x = function(n) {
            ...
            return arguments.length ? (o = "function" == typeof n ? i = n : (i = _s.get(n) || ao).key, t) : o
    ...
    function go(n, t) {
        return n.length < 3 ? ao(n) : n[0] + vo((n.push(n[0]), n), mo([n[n.length - 2]].concat(n, [n[1]]), t))
    }
    function po(n, t) {
    ...
    function yo(n) {
        ...
        var t = 1,
            ...
            o = [u, u, u, (r = n[1])[0]],
            a = [i, i, i, r[1]],
            c = [u, ",", i, "L", bo(Ss, o), ",", bo(Ss, a)];
        for (n.push(n[e - 1]); ++t <= e;)
            r = n[t], o.shift(), o.push(r[0]), a.shift(), a.push(r[1]), wo(c, o, a);
    ...
    function xo(n) {
        ...
        for (e.push(bo(Ss, i) + "," + bo(Ss, o)), --r; ++r < u;)
            t = n[r], i.shift(), i.push(t[0]), o.shift(), o.push(t[1]), wo(e, i, o);
        return e.join("")
    }
    function Mo(n) {
        for (var t, e, r = -1, u = n.length, i = u + 4, o = [], a = []; ++r < 4;)
            e = n[r % u], o.push(e[0]), a.push(e[1]);
        for (t = [bo(Ss, o), ",", bo(Ss, a)], --r; ++r < i;)
            e = n[r % u], o.shift(), o.push(e[0]), a.shift(), a.push(e[1]), wo(t, o, a);
        return t.join("")
    }
    function _o(n, t) {
        var e = n.length - 1;
    ...
    function wo(n, t, e) {
        n.push("C", bo(bs, t), ",", bo(bs, e), ",", bo(ws, t), ",", bo(ws, e), ",", bo(Ss, t), ",", bo(Ss, e))
    }
    function So(n, t) {
        return (t[1] - n[1]) / (t[0] - n[0])
    }
    function ko(n) {
        for (var t = 0, e = n.length - 1, r = [], u = n[0], i = n[1], o = r[0] = So(u, i); ++t < e;)
            r[t] = (o + (o = So(u = i, i = n[t + 1]))) / 2;
        return r[t] = o, r
    }
    function Eo(n) {
        for (var t, e, r, u, i = [], o = ko(n), a = -1, c = n.length - 1; ++a < c;)
            t = So(n[a], n[a + 1]), aa(t) < Ca ? o[a] = o[a + 1] = 0 : (e = o[a] / t, r = o[a + 1] / t, u = e * e + r * r, u > 9 && (u = 3 * t / Math.sqrt(u), o[a] = u * e, o[a + 1] = u * r));
        for (a = -1; ++a <= c;)
            u = (n[Math.min(c, a + 1)][0] - n[Math.max(0, a - 1)][0]) / (6 * (1 + o[a] * o[a])), i.push([u || 0, o[a] * u || 0]);
        return i
    }
    function Ao(n) {
        return n.length < 3 ? ao(n) : n[0] + vo(n, Eo(n))
    }
    function Co(n) {
        for (var t, e, r, u = -1, i = n.length; ++u < i;)
            t = n[u], e = t[0], r = t[1] + xs, t[0] = e * Math.cos(r), t[1] = e * Math.sin(r);
        return n
    }
    function No(n) {
        function t(t) {
        ...
        return t.x = function(n) {
            ...
            return arguments.length ? (c = "function" == typeof n ? a = n : (a = _s.get(n) || ao).key, s = a.reverse || a, l = a.closed ? "M" : "L", t) : c
        }, t.tension = function(n) {
    ...
    function Io(n, t, e) {
        ...
        function u(n, e) {
            var r = n[1] - n[0],
                u = r / e,
                i = $o.bisect(Hs, u);
            return i == Hs.length ? [t.year, Ii(n.map(function(n) {
                return n / 31536e6
            }), e)[2]] : i ? t[u / Hs[i - 1] < Hs[i] / u ? i - 1 : i] : [Ys, Ii(n, e)[2]]
        }
        return r.invert = function(t) {
    ...
    ma.select = function(n) {
        ...
        for (var u = -1, i = this.length; ++u < i;)
            for (var o = this[u], a = -1, c = o.length; ++a < c;)
                (e = o[a]) && (r.push(t = Wo(n.call(e, e.__data__, a, u))), t.parentNode = e);
        return x(r)
    };
    var ya = {
    ...
    var xa = [];
    $o.selection.enter = D, $o.selection.enter.prototype = xa, xa.append = ma.append, xa.empty = ma.empty, xa.node = ma.node, xa.call = ma.call, xa.size = ma.size, xa.select = function(n) {
        ...
        return arguments.length < 2 && (t = P(this)), ma.insert.call(this, n, t)
    }, ma.transition = function() {
        for (var n, t, e = Es || ++zs, r = [], u = As || {
                time: Date.now(),
                ease: xu,
                delay: 0,
                duration: 250
    ...
    var ba = "onselectstart" in Jo ? null : h(Go.style, "userSelect"),
        wa = 0;
    $o.mouse = function(n) {
        return Y(n, m())
    };
    ...
    $o.touches = function(n, t) {
        return arguments.length < 2 && (t = m().touches), t ? Wo(t).map(function(t) {
            var e = Y(n, t);
        ...
        var u = y(n, "drag", "dragstart", "dragend"),
            i = null,
            o = r(g, $o.mouse, "mousemove", "mouseup"),
    ...
    $o.interpolateZoom = function(n, t) {
        function e(n) {
            ...
            if (m) {
                var e = W(v),
                    o = i / (Ta * h) * (e * J(qa * t + v) - B(v));
                return [r + o * s, u + o * l, i * e / W(qa * t + v)]
            }
        ...
        var r = n[0],
            ...
            f = s * s + l * l,
            h = Math.sqrt(f),
            g = (c * c - i * i + Ra * f) / (2 * i * Ta * h),
            p = (c * c - i * i - Ra * f) / (2 * c * Ta * h),
        ...
        function n(n) {
            n.on(A, s).on(Ua + ".zoom", f).on(C, h).on("dblclick.zoom", g).on(L, l)
        }
        function t(n) {
        ...
        function s() {
            function n() {
                l = 1, u($o.mouse(r), g), a(i)
            }
            function e() {
                f.on(C, Ko === r ? h : null).on(N, null), p(l && $o.event.target === s), c(i)
            }
            var r = this,
                i = z.of(r, arguments),
                s = $o.event.target,
        ...
        function l() {
            ...
            function i() {
                for (var n, t, e, i, o = $o.touches(g), c = 0, s = o.length; s > c; ++c, i = null)
            ...
            var h,
                ...
                M = "touchmove.zoom-" + y,
                _ = "touchend.zoom-" + y,
                b = $o.select(Ko).on(M, i).on(_, f),
                w = $o.select(g).on(A, null).on(L, e),
                k = O();
            U.call(g), e(), o(p)
        }
        function f() {
            ...
            var e = v || $o.mouse(this);
            p || (p = t(e)), r(Math.pow(2, .002 * Da()) * S.k), u(e, p), a(n)
        }
        function h() {
            p = null
        }
        ...
        return n.event = function(n) {
            n.each(function() {
                var n = z.of(this, arguments),
                    t = S;
                Es ? $o.select(this).transition().each("start.zoom", function() {
                    S = this.__chart__ || {
                        x: 0,
                        y: 0,
                        k: 1
    ...
    K.prototype.toString = function() {
        ...
        return 1 === arguments.length ? n instanceof nt ? Q(n.h, n.s, n.l) : mt("" + n, yt, Q) : Q(+n, +t, +e)
    };
    var ja = nt.prototype = new K;
    ja.brighter = function(n) {
        return n = Math.pow(.7, arguments.length ? n : 1), Q(this.h, this.s, this.l / n)
    }, ja.darker = function(n) {
        return n = Math.pow(.7, arguments.length ? n : 1), Q(this.h, this.s, n * this.l)
    }, ja.rgb = function() {
        return tt(this.h, this.s, this.l)
    }, $o.hcl = function(n, t, e) {
        return 1 === arguments.length ? n instanceof rt ? et(n.h, n.c, n.l) : n instanceof ot ? ct(n.l, n.a, n.b) : ct((n = xt((n = $o.rgb(n)).r, n.g, n.b)).l, n.a, n.b) : et(+n, +t, +e)
    };
    var Ha = rt.prototype = new K;
    Ha.brighter = function(n) {
        return et(this.h, this.c, Math.min(100, this.l + Fa * (arguments.length ? n : 1)))
    }, Ha.darker = function(n) {
        return et(this.h, this.c, Math.max(0, this.l - Fa * (arguments.length ? n : 1)))
    }, Ha.rgb = function() {
        return ut(this.h, this.c, this.l).rgb()
    }, $o.lab = function(n, t, e) {
        return 1 === arguments.length ? n instanceof ot ? it(n.l, n.a, n.b) : n instanceof rt ? ut(n.l, n.c, n.h) : xt((n = $o.rgb(n)).r, n.g, n.b) : it(+n, +t, +e)
    };
    var Fa = 18,
        Oa = .95047,
        Ya = 1,
        Ia = 1.08883,
        Za = ot.prototype = new K;
    Za.brighter = function(n) {
        return it(Math.min(100, this.l + Fa * (arguments.length ? n : 1)), this.a, this.b)
    }, Za.darker = function(n) {
        return it(Math.max(0, this.l - Fa * (arguments.length ? n : 1)), this.a, this.b)
    }, Za.rgb = function() {
        return at(this.l, this.a, this.b)
    }, $o.rgb = function(n, t, e) {
        return 1 === arguments.length ? n instanceof vt ? pt(n.r, n.g, n.b) : mt("" + n, pt, tt) : pt(~~n, ~~t, ~~e)
    };
    var Va = vt.prototype = new K;
    Va.brighter = function(n) {
        ...
        var t = this.r,
            ...
            r = this.b,
            u = 30;
        return t || e || r ? (t && u > t && (t = u), e && u > e && (e = u), r && u > r && (r = u), pt(Math.min(255, ~~(t / n)), Math.min(255, ~~(e / n)), Math.min(255, ~~(r / n)))) : pt(u, u, u)
    }, Va.darker = function(n) {
        return n = Math.pow(.7, arguments.length ? n : 1), pt(~~(n * this.r), ~~(n * this.g), ~~(n * this.b))
    }, Va.hsl = function() {
    ...
    Xa.forEach(function(n, t) {
        Xa.set(n, ht(t))
    }), $o.functor = bt, $o.xhr = St(wt), $o.dsv = function(n, t) {
        function e(n, e, i) {
    ...
    var $a,
        ...
        Ja,
        Ga,
        Ka = Ko[h(Ko, "requestAnimationFrame")] || function(n) {
            setTimeout(n, 17)
        };
    $o.timer = function(n, t, e) {
        ...
        Ba ? Ba.n = i : $a = i, Ba = i, Wa || (Ja = clearTimeout(Ja), Wa = 1, Ka(At))
    }, $o.timer.flush = function() {
        Ct(), Nt()
    }, $o.round = function(n, t) {
        return t ? Math.round(n * (t = Math.pow(10, t))) / t : Math.round(n)
    };
    var Qa = ["y", "z", "a", "f", "p", "n", "\xb5", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(zt);
    $o.formatPrefix = function(n, t) {
        var e = 0;
        return n && (0 > n && (n *= -1), t && (n = $o.round(n, Lt(n, t))), e = 1 + Math.floor(1e-12 + Math.log(n) / Math.LN10), e = Math.max(-24, Math.min(24, 3 * Math.floor((0 >= e ? e + 1 : e - 1) / 3)))), Qa[8 + e / 3]
    };
    var nc = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,
        tc = $o.map({
            b: function(n) {
            ...
            r: function(n, t) {
                return (n = $o.round(n, Lt(n, t))).toFixed(Math.max(0, Math.min(20, Lt(n * (1 + 1e-15), t))))
            }
        }),
        ec = $o.time = {},
        rc = Date;
    ...
    ec.year = Dt(function(n) {
        return n = ec.day(n), n.setMonth(0, 1), n
    }, function(n, t) {
        n.setFullYear(n.getFullYear() + t)
    }, function(n) {
        return n.getFullYear()
    }), ec.years = ec.year.range, ec.years.utc = ec.year.utc.range, ec.day = Dt(function(n) {
        var t = new rc(2e3, 0);
        ...
        return n.getDate() - 1
    }), ec.days = ec.day.range, ec.days.utc = ec.day.utc.range, ec.dayOfYear = function(n) {
        var t = ec.year(n);
        return Math.floor((n - t - 6e4 * (n.getTimezoneOffset() - t.getTimezoneOffset())) / 864e5)
    }, ["sunday", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday"].forEach(function(n, t) {
        t = 7 - t;
        var e = ec[n] = Dt(function(n) {
            return (n = ec.day(n)).setDate(n.getDate() - (n.getDay() + t) % 7), n
        }, function(n, t) {
            n.setDate(n.getDate() + 7 * Math.floor(t))
        }, function(n) {
            var e = ec.year(n).getDay();
            return Math.floor((ec.dayOfYear(n) + (e + t) % 7) / 7) - (e !== t)
        });
        ec[n + "s"] = e.range, ec[n + "s"].utc = e.utc.range, ec[n + "OfYear"] = function(n) {
            var e = ec.year(n).getDay();
            return Math.floor((ec.dayOfYear(n) + (e + t) % 7) / 7)
        }
    }), ec.week = ec.sunday, ec.weeks = ec.sunday.range, ec.weeks.utc = ec.sunday.utc.range, ec.weekOfYear = ec.sundayOfYear;
    var ic = {
            "-": "",
            _: " ",
            0: "0"
    ...
    $o.format = cc.numberFormat, $o.geo = {}, ue.prototype = {
        s: 0,
        t: 0,
        add: function(n) {
            ie(n, this.t, sc), ie(sc.s, this.s, this), this.s ? this.t += sc.t : this.s = sc.t
        },
        reset: function() {
            this.s = this.t = 0
        },
    ...
    $o.geo.stream = function(n, t) {
        n && lc.hasOwnProperty(n.type) ? lc[n.type](n, t) : oe(n, t)
    };
    var lc = {
    ...
    $o.geo.area = function(n) {
        return hc = 0, $o.geo.stream(n, pc), hc
    };
    var hc,
        gc = new ue,
        pc = {
            ...
            lineEnd: g,
            polygonStart: function() {
                gc.reset(), pc.lineStart = se
            },
            polygonEnd: function() {
                var n = 2 * gc;
                hc += 0 > n ? 4 * ka + n : n, pc.lineStart = pc.lineEnd = pc.point = g
            }
        };
    $o.geo.bounds = function() {
        ...
        function o() {
            u(v, d), pc.lineEnd(), aa(y) > Ca && (l = -(h = 180)), M[0] = l, M[1] = h, m = null
        }
        function a(n, t) {
        ...
        var l,
            ...
            _ = {
                ...
                polygonEnd: function() {
                    pc.polygonEnd(), _.point = n, _.lineStart = e, _.lineEnd = r, 0 > gc ? (l = -(h = 180), f = -(g = 90)) : y > Ca ? g = 90 : -Ca > y && (f = -90), M[0] = l, M[1] = h
                }
            };
        return function(n) {
        ...
        vc = dc = mc = yc = xc = Mc = _c = bc = wc = Sc = kc = 0, $o.geo.stream(n, Ec);
        var t = wc,
            e = Sc,
            r = kc,
            u = t * t + e * e + r * r;
        return Na > u && (t = Mc, e = _c, r = bc, Ca > dc && (t = mc, e = yc, r = xc), u = t * t + e * e + r * r, Na > u) ? [0 / 0, 0 / 0] : [Math.atan2(e, t) * za, $(r / Math.sqrt(u)) * za]
    };
    var vc,
        dc,
        mc,
    ...
    var Nc,
        ...
        Dc = {
            ...
            lineEnd: g,
            polygonStart: function() {
                Lc = 0, Dc.lineStart = Oe
            },
            polygonEnd: function() {
                Dc.lineStart = Dc.lineEnd = Dc.point = g, Nc += aa(Lc / 2)
            }
        },
        Pc = {
            point: Ye,
        ...
        Uc = {
            ...
            polygonEnd: function() {
                Uc.point = Ve, Uc.lineStart = Xe, Uc.lineEnd = $e
            }
        };
    $o.geo.path = function() {
        function n(n) {
        ...
        return n.area = function(n) {
            return Nc = 0, $o.geo.stream(n, u(Dc)), Nc
        }, n.centroid = function(n) {
            return mc = yc = xc = Mc = _c = bc = wc = Sc = kc = 0, $o.geo.stream(n, u(Uc)), kc ? [wc / kc, Sc / kc] : bc ? [Mc / bc, _c / bc] : xc ? [mc / xc, yc / xc] : [0 / 0, 0 / 0]
        }, n.bounds = function(n) {
            return Tc = Rc = -(zc = qc = 1 / 0), $o.geo.stream(n, u(Pc)), [[zc, qc], [Tc, Rc]]
    ...
    }, $o.geo.projection = nr, $o.geo.projectionMutator = tr, ($o.geo.equirectangular = function() {
        return nr(rr)
    }).raw = rr.invert = rr, $o.geo.rotation = function(n) {
        function t(t) {
            return t = n(t[0] * La, t[1] * La), t[0] *= za, t[1] *= za, t
        }
        return n = ir(n[0] % 360 * La, n[1] * La, n.length > 2 ? n[2] * La : 0), t.invert = function(t) {
            return t = n.invert(t[0] * La, t[1] * La), t[0] *= za, t[1] *= za, t
        }, t
    }, ur.invert = rr, $o.geo.circle = function() {
        function n() {
            var n = "function" == typeof r ? r.apply(this, arguments) : r,
                t = ir(-n[0] * La, -n[1] * La, 0).invert,
                u = [];
            return e(null, null, 1, {
                point: function(n, e) {
                    u.push(n = t(n, e)), n[0] *= za, n[1] *= za
                }
            }), {
                type: "Polygon",
                coordinates: [u]
        ...
        return n.origin = function(t) {
            ...
            return arguments.length ? (e = sr((t = +r) * La, u * La), n) : t
        }, n.precision = function(r) {
            return arguments.length ? (e = sr(t * La, (u = +r) * La), n) : u
        }, n.angle(90)
        ...
        return vr(n[0] * La, n[1] * La, t[0] * La, t[1] * La)
    }, $o.geo.length = function(n) {
        return jc = 0, $o.geo.stream(n, Hc), jc
    };
    var jc,
        Hc = {
            sphere: g,
    ...
    ($o.geo.azimuthalEquidistant = function() {
        return nr(Oc)
    }).raw = Oc, ($o.geo.conicConformal = function() {
        return He(yr)
    }).raw = yr, ($o.geo.conicEquidistant = function() {
        return He(xr)
    }).raw = xr;
    var Yc = mr(function(n) {
        return 1 / n
    }, Math.atan);
    ($o.geo.gnomonic = function() {
        return nr(Yc)
    }).raw = Yc, Mr.invert = function(n, t) {
    ...
    }).raw = br, $o.geom = {}, $o.geom.hull = function(n) {
        function t(n) {
            if (n.length < 3)
                return [];
            var t,
    ...
    var Vc = $o.geom.polygon.prototype = [];
    Vc.area = function() {
    ...
    }, $o.interpolateRgb = cu, $o.interpolateObject = su, $o.interpolateNumber = lu, $o.interpolateString = fu;
    var ns = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g;
    $o.interpolate = hu, $o.interpolators = [function(n, t) {
        var e = typeof t;
        return ("string" === e ? Xa.has(t) || /^(#|rgb\(|hsl\()/.test(t) ? cu : fu : t instanceof K ? cu : "object" === e ? Array.isArray(t) ? gu : su : lu)(n, t)
    }], $o.interpolateArray = gu;
    var ts = function() {
            return wt
        },
        es = $o.map({
    ...
    $o.ease = function(n) {
        ...
        return e = es.get(e) || ts, r = rs.get(r) || wt, pu(r(e.apply(null, Bo.call(arguments, 1))))
    }, $o.interpolateHcl = Au, $o.interpolateHsl = Cu, $o.interpolateLab = Nu, $o.interpolateRound = Lu, $o.transform = function(n) {
    ...
    $o.interpolateTransform = Du, $o.layout = {}, $o.layout.bundle = function() {
        return function(n) {
        ...
        return a.tick = function() {
            ...
            if (g)
                for (Vu(t = $o.geom.quadtree(m), r, o), e = -1; ++e < _;)
            ...
            return e || (e = $o.behavior.drag().origin(wt).on("dragstart.force", Ou).on("drag.force", t).on("dragend.force", Yu)), arguments.length ? (this.on("mouseover.force", Iu).on("mouseout.force", Zu).call(e), void 0) : e
        }, $o.rebind(a, c, "on")
    };
    var is = 20,
        os = 1,
    ...
    $o.layout.hierarchy = function() {
        ...
        function n(i) {
            var o = i.map(function(e, r) {
                ...
                s = $o.range(i.length);
            null != e && s.sort(e === cs ? function(n, t) {
                return o[t] - o[n]
            } : function(n, t) {
                return e(i[n], i[t])
            });
    ...
    $o.layout.stack = function() {
        ...
        return n.values = function(e) {
            ...
            return arguments.length ? (e = "function" == typeof t ? t : ss.get(t) || ni, n) : e
        }, n.offset = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : ls.get(t) || ti, n) : r
        }, n.x = function(t) {
            return arguments.length ? (i = t, n) : i
        }, n.y = function(t) {
    ...
    $o.layout.histogram = function() {
        function n(n, i) {
            ...
            if (g > 0)
                for (i = -1; ++i < h;)
                    a = s[i], a >= l[0] && a <= l[1] && (o = c[$o.bisect(f, a, 1, g) - 1], o.y += p, o.push(n[i]));
            return c
        }
        var t = !0,
            e = Number,
        ...
        function n(n, i) {
            ...
            function c(n, t, r) {
                if (t) {
                    for (var u, i = n, o = n, a = t, c = n.parent.children[0], s = i._tree.mod, l = o._tree.mod, f = a._tree.mod, h = c._tree.mod; a = li(a), i = si(i), a && i;)
                        c = si(c), o = li(o), o._tree.ancestor = n, u = a._tree.prelim + f - i._tree.prelim - s + e(a, i), u > 0 && (mi(yi(a, n, r), n, u), s += u, l += u), f += a._tree.mod, s += i._tree.mod, h += c._tree.mod, l += o._tree.mod;
                    a && !li(o) && (o._tree.thread = a, o._tree.mod += f - l), i && !si(c) && (c._tree.thread = i, c._tree.mod += s - h, r = n)
                }
                return r
            }
        ...
        function n(n, i) {
            ...
            if (a.x = a.y = 0, vi(a, function(n) {
                n.r = +l(n.value)
            }), vi(a, wi), r) {
                var f = r * (t ? 1 : Math.max(2 * a.r / c, 2 * a.r / s)) / 2;
                vi(a, function(n) {
                    n.r += f
                }), vi(a, wi), vi(a, function(n) {
                    n.r -= f
                })
            }
            return Ei(a, c / 2, s / 2, t ? 1 : 1 / Math.max(2 * a.r / c, 2 * a.r / s)), o
        }
        var t,
            e = $o.layout.hierarchy().sort(xi),
            r = 0,
            u = [1, 1];
        ...
        function n(n, i) {
            ...
            vi(c, function(n) {
                var t = n.children;
                t && t.length ? (n.x = Ni(t), n.y = Ci(t)) : (n.x = o ? s += e(n, o) : 0, n.y = 0, o = n)
            });
            var l = Li(c),
                f = zi(c),
                h = l.x - e(l, f) / 2,
                g = f.x + e(f, l) / 2;
            return vi(c, u ? function(n) {
        ...
        return i.size = function(n) {
            ...
            function t(t) {
                ...
                return null == e ? qi(t) : Ti(t, "number" == typeof e ? [e, e, e, e] : e)
            }
            function e(t) {
                return Ti(t, n)
            }
            if (!arguments.length)
                return l;
            var r;
            return f = null == (l = n) ? qi : "function" == (r = typeof n) ? t : "number" === r ? (n = [n, n, n, n], e) : e, i
        }, i.round = function(n) {
    ...
    $o.scale.log = function() {
        return Bi($o.scale.linear().domain([0, 1]), 10, !0, [1, 10])
    };
    var gs = $o.format(".0e"),
        ps = {
            floor: function(n) {
    ...
    $o.scale.pow = function() {
        return Wi($o.scale.linear(), 1, [0, 1])
        ...
        return $o.scale.ordinal().range(ms)
    }, $o.scale.category20c = function() {
        return $o.scale.ordinal().range(ys)
    };
    var vs = [2062260, 16744206, 2924588, 14034728, 9725885, 9197131, 14907330, 8355711, 12369186, 1556175].map(gt),
        ds = [2062260, 11454440, 16744206, 16759672, 2924588, 10018698, 14034728, 16750742, 9725885, 12955861, 9197131, 12885140, 14907330, 16234194, 8355711, 13092807, 12369186, 14408589, 1556175, 10410725].map(gt),
        ms = [3750777, 5395619, 7040719, 10264286, 6519097, 9216594, 11915115, 13556636, 9202993, 12426809, 15186514, 15190932, 8666169, 11356490, 14049643, 15177372, 8077683, 10834324, 13528509, 14589654].map(gt),
        ys = [3244733, 7057110, 10406625, 13032431, 15095053, 16616764, 16625259, 16634018, 3253076, 7652470, 10607003, 13101504, 7695281, 10394312, 12369372, 14342891, 6513507, 9868950, 12434877, 14277081].map(gt);
    $o.scale.quantile = function() {
        ...
        function n() {
            var n = t.apply(this, arguments),
                ...
                h = Math.cos(a),
                g = Math.sin(a);
            return c >= Ms ? n ? "M0," + i + "A" + i + "," + i + " 0 1,1 0," + -i + "A" + i + "," + i + " 0 1,1 0," + i + "M0," + n + "A" + n + "," + n + " 0 1,0 0," + -n + "A" + n + "," + n + " 0 1,0 0," + n + "Z" : "M0," + i + "A" + i + "," + i + " 0 1,1 0," + -i + "A" + i + "," + i + " 0 1,1 0," + i + "Z" : n ? "M" + i * l + "," + i * f + "A" + i + "," + i + " 0 " + s + ",1 " + i * h + "," + i * g + "L" + n * h + "," + n * g + "A" + n + "," + n + " 0 " + s + ",0 " + n * l + "," + n * f + "Z" : "M" + i * l + "," + i * f + "A" + i + "," + i + " 0 " + s + ",1 " + i * h + "," + i * g + "L0,0" + "Z"
        }
        var t = eo,
            e = ro,
            r = uo,
        ...
        return n.innerRadius = function(e) {
            ...
            var n = (t.apply(this, arguments) + e.apply(this, arguments)) / 2,
                i = (r.apply(this, arguments) + u.apply(this, arguments)) / 2 + xs;
    ...
    $o.svg.line.radial = function() {
    ...
    }, lo.reverse = fo, fo.reverse = lo, $o.svg.area = function() {
        return No(wt)
        ...
        function n(n, r) {
            return (ks.get(t.call(this, n, r)) || Do)(e.call(this, n, r))
        }
        var t = Ro,
            e = To;
    ...
    var Es,
        ...
        Ls = [],
        zs = 0;
    Ls.call = ma.call, Ls.empty = ma.empty, Ls.node = ma.node, Ls.size = ma.size, $o.transition = function(n) {
        return arguments.length ? Es ? n.transition() : n : Ma.transition()
    }, $o.transition.prototype = Ls, Ls.select = function(n) {
        var t,
            e,
            r,
            u = this.id,
        ...
        for (var o = -1, a = this.length; ++o < a;) {
            ...
            for (var c = this[o], s = -1, l = c.length; ++s < l;)
                (r = c[s]) && (e = n.call(r, r.__data__, s, o)) ? ("__data__" in r && (e.__data__ = r.__data__), Ho(e, s, u, r.__transition__[u]), t.push(e)) : t.push(null)
        }
        return Po(i, u)
        ...
        var o = "transform" == n ? Du : hu,
            a = $o.ns.qualify(n);
        return Uo(this, "attr." + n, t, a.local ? i : u)
        ...
        return Uo(this, "style." + n, t, u)
    }, Ls.styleTween = function(n, t, e) {
        function r(r, u) {
        ...
        var t = this.id;
        return arguments.length < 1 ? this.node().__transition__[t].ease : ("function" != typeof n && (n = $o.ease.apply($o, arguments)), R(this, function(e) {
        ...
        if (arguments.length < 2) {
            var r = As,
                u = Es;
            Es = e, R(this, function(t, r, u) {
                As = t.__transition__[e], n.call(t, t.__data__, r, u)
            }), As = r, Es = u
        } else
            R(this, function(r) {
        ...
        for (var n, t, e, r, u = this.id, i = ++zs, o = [], a = 0, c = this.length; c > a; a++) {
            o.push(n = []);
            for (var t = this[a], s = 0, l = t.length; l > s; s++)
                (e = t[s]) && (r = Object.create(e.__transition__[u]), r.delay += r.duration, Ho(e, s, i, r)), n.push(e)
        }
        return Po(o, i)
    }, $o.svg.axis = function() {
        function n(n) {
            n.each(function() {
                ...
                switch (r) {
                case "bottom":
                    n = Fo, _.attr("y2", u), S.attr("y", Math.max(u, 0) + o), b.attr("x2", 0).attr("y2", u), k.attr("x", 0).attr("y", Math.max(u, 0) + o), w.attr("dy", ".71em").style("text-anchor", "middle"), M.attr("d", "M" + y[0] + "," + i + "V0H" + y[1] + "V" + i);
                    break;
                case "top":
                    n = Fo, _.attr("y2", -u), S.attr("y", -(Math.max(u, 0) + o)), b.attr("x2", 0).attr("y2", -u), k.attr("x", 0).attr("y", -(Math.max(u, 0) + o)), w.attr("dy", "0em").style("text-anchor", "middle"), M.attr("d", "M" + y[0] + "," + -i + "V0H" + y[1] + "V" + -i);
                    break;
                case "left":
        ...
        return n.scale = function(t) {
            ...
            return arguments.length ? (r = t in Ts ? t + "" : qs, n) : r
        }, n.ticks = function() {
    ...
    $o.svg.brush = function() {
        function n(i) {
            i.each(function() {
                ...
                var l,
                    f = $o.transition(i),
                    h = $o.transition(o);
                c && (l = Di(c), h.attr("x", l[0]).attr("width", l[1] - l[0]), e(f)), s && (l = Di(s), h.attr("y", l[0]).attr("height", l[1] - l[0]), r(f)), t(f)
            })
        }
        function t(n) {
        ...
        function u() {
            function u() {
                32 == $o.event.keyCode && (C || (x = null, L[0] -= l[1], L[1] -= f[1], C = 2), d())
            }
            function p() {
                32 == $o.event.keyCode && 2 == C && (L[0] += l[1], L[1] += f[1], C = 0, d())
            }
            function v() {
                var n = $o.mouse(_),
                    u = !1;
                M && (n[0] += M[0], n[1] += M[1]), C || ($o.event.altKey ? (x || (x = [(l[0] + l[1]) / 2, (f[0] + f[1]) / 2]), L[0] = l[+(n[0] < x[0])], L[1] = f[+(n[1] < x[1])]) : x = null), E && m(n, c, 0) && (e(S), u = !0), A && m(n, s, 1) && (r(S), u = !0), u && (t(S), w({
                    type: "brush",
                    mode: C ? "move" : "resize"
                }))
            }
            ...
            function y() {
                v(), S.style("pointer-events", "all").selectAll(".resize").style("display", n.empty() ? "none" : null), $o.select("body").style("cursor", null), z.on("mousemove.brush", null).on("mouseup.brush", null).on("touchmove.brush", null).on("touchend.brush", null).on("keydown.brush", null).on("keyup.brush", null), N(), w({
                    type: "brushend"
                })
            }
            var x,
                ...
                N = O(),
                L = $o.mouse(_),
                z = $o.select(Ko).on("keydown.brush", u).on("keyup.brush", p);
            if ($o.event.changedTouches ? z.on("touchmove.brush", v).on("touchend.brush", y) : z.on("mousemove.brush", v).on("mouseup.brush", y), S.interrupt().selectAll("*").interrupt(), C)
        ...
        return n.event = function(n) {
            n.each(function() {
                var n = a.of(this, arguments),
                    ...
                    e = this.__chart__ || t;
                this.__chart__ = t, Es ? $o.select(this).transition().each("start.brush", function() {
            ...
            return arguments.length ? (c = t, p = Ds[!c << 1 | !s], n) : c
        }, n.y = function(t) {
            return arguments.length ? (s = t, p = Ds[!c << 1 | !s], n) : s
        }, n.clamp = function(t) {
    ...
    var Rs = {
        ...
        Ds = [["n", "e", "s", "w", "nw", "ne", "se", "sw"], ["e", "w"], ["n", "s"], []],
        Ps = ec.format = cc.timeFormat,
        Us = Ps.utc,
        js = Us("%Y-%m-%dT%H:%M:%S.%LZ");
    Ps.iso = Date.prototype.toISOString && +new Date("2000-01-01T00:00:00.000Z") ? Yo : js, Yo.parse = function(n) {
        var t = new Date(n);
        return isNaN(t) ? null : t
    }, Yo.toString = js.toString, ec.second = Dt(function(n) {
        return new rc(1e3 * Math.floor(n / 1e3))
    }, function(n, t) {
        n.setTime(n.getTime() + 1e3 * Math.floor(t))
    }, function(n) {
        return n.getSeconds()
    }), ec.seconds = ec.second.range, ec.seconds.utc = ec.second.utc.range, ec.minute = Dt(function(n) {
        return new rc(6e4 * Math.floor(n / 6e4))
    }, function(n, t) {
        n.setTime(n.getTime() + 6e4 * Math.floor(t))
    }, function(n) {
        return n.getMinutes()
    }), ec.minutes = ec.minute.range, ec.minutes.utc = ec.minute.utc.range, ec.hour = Dt(function(n) {
        var t = n.getTimezoneOffset() / 60;
        return new rc(36e5 * (Math.floor(n / 36e5 - t) + t))
    }, function(n, t) {
        n.setTime(n.getTime() + 36e5 * Math.floor(t))
    }, function(n) {
        return n.getHours()
    }), ec.hours = ec.hour.range, ec.hours.utc = ec.hour.utc.range, ec.month = Dt(function(n) {
        return n = ec.day(n), n.setDate(1), n
    }, function(n, t) {
        n.setMonth(n.getMonth() + t)
    }, function(n) {
        return n.getMonth()
    }), ec.months = ec.month.range, ec.months.utc = ec.month.utc.range;
    var Hs = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6],
        Fs = [[ec.second, 1], [ec.second, 5], [ec.second, 15], [ec.second, 30], [ec.minute, 1], [ec.minute, 5], [ec.minute, 15], [ec.minute, 30], [ec.hour, 1], [ec.hour, 3], [ec.hour, 6], [ec.hour, 12], [ec.day, 1], [ec.day, 2], [ec.week, 1], [ec.month, 1], [ec.month, 3], [ec.year, 1]],
        Os = Ps.multi([[".%L", function(n) {
        ...
        Ys = {
            range: function(n, t, e) {
                return $o.range(+n, +t, e).map(Zo)
            },
            floor: wt,
            ceil: wt
        };
    Fs.year = ec.year, ec.scale = function() {
        return Io($o.scale.linear(), Fs, Os)
    };
    var Is = Fs.map(function(n) {
            return [n[0].utc, n[1]]
        }),
        Zs = Us.multi([[".%L", function(n) {
    ...
    Is.year = ec.year.utc, ec.scale.utc = function() {
        return Io($o.scale.linear(), Is, Zs)
    }, $o.text = St(function(n) {
        return n.responseText
    }), $o.json = function(n, t) {
        return kt(n, "application/json", Vo, t)
    }, $o.html = function(n, t) {
        return kt(n, "text/html", Xo, t)
    }, $o.xml = St(function(n) {
        return n.responseXML
    }), "function" == typeof define && define.amd ? define($o) : "object" == typeof module && module.exports ? module.exports = $o : this.d3 = $o
}();
